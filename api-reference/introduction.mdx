...
<Warning>
  ...
  <a href="mailto:hi@launchpointhq.com">adam@launchpointhq.com</a> for questions or early access.
</Warning>
...
| Version | Status    | Release Date | Supported Until | Status       |
| ------- | --------- | ------------ | --------------- | ------------ |
...
| `campaigns:write` | Create, update, and transition campaigns and tasks (implies read) |
